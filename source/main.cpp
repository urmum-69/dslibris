...
//---------------------------------------------------------------------------------
int dirlist(int argc, char **argv) {
//---------------------------------------------------------------------------------
...
"           librOS 1.0           \n");
	...
	// Initialize NitroFS for fileservice.
	// libfat stopped working in r49.
	iprintf(
"    bringing up filesystem...   \n");
	if(nitroFSInit(NULL))
		iprintf(
"    NitroFS is up.              \n");
	else
		iprintf(
"    NitroFS failed to come up!  \n");
	
	// Let things get drawn.
	swiWaitForVBlank();
